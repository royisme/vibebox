...
- `runbooks/apple-vm-sign-and-verify.md`: signing, entitlement checks, and apple-vm readiness verification.
...
- `runbooks/mozi-consumer-guide.md`: install and runtime integration guide for Bun/TypeScript Mozi project.
